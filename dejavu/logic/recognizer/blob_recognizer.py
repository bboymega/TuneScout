...
from dejavu.config.settings import (ALIGN_TIME, FINGERPRINT_TIME, QUERY_TIME, RESULTS, TOTAL_TIME)


class BlobRecognizer(BaseRecognizer):
    ...
    def recognize(self, blob) -> Dict[str, any]:
        return self.recognize_file(blob)
